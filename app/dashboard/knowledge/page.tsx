...
export default function KnowledgeBase() {
  ...
  const fetchKBItems = async () => {
    ...
    setLoading(true);
    try {
      const data = await apiFetch<KBItem[]>(`/api/dashboard/knowledge?workspace_id=${encodeURIComponent(workspaceId)}`);
      setItems(data);
    } catch (e) {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiFetch(`/api/dashboard/knowledge?workspace_id=${encodeURIComponent(workspaceId || "")}`, {
        method: "POST",
        body: JSON.stringify({
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await apiFetch(`/api/dashboard/knowledge/${id}?workspace_id=${encodeURIComponent(workspaceId || "")}`, {
        method: "DELETE",
      });
      fetchKBItems();
    } catch (e: any) {
