    ...
    <div className="min-h-screen flex items-center justify-center bg-darkBg p-8">
      <div className="glass-panel border border-glassBorder rounded-2xl p-8 max-w-md w-full text-center">
        ...
        <div className="flex flex-col gap-3">
          <button
            onClick={onRetry}
            className="w-full px-6 py-3 bg-gradient-to-r from-sleekCyan to-neonPurple text-darkBg font-semibold rounded-xl hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <Link
            href="/overview"
            className="w-full px-6 py-3 glass-panel border border-glassBorder text-gray-300 font-medium rounded-xl hover:border-sleekCyan/50 hover:text-sleekCyan transition-colors flex items-center justify-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="none"
